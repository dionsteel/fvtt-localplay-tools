...
export declare global {
  ...
  abstract class CompendiumCollection<TDocument extends CompendiumDocument = CompendiumDocument> extends DocumentCollection<TDocument> {
    ...
    protected _onModifyContents(documents: TDocument[], options: DocumentModificationContext<null>, userId: string): void;
  }
  ...
  function fromUuid(uuid: TokenDocumentUUID, relative?: foundry.abstract.Document): Promise<TokenDocument<Scene> | null>;
  function fromUuid<TDocument extends ClientDocument>(uuid: string, relative?: foundry.abstract.Document): Promise<TDocument | null>;
  ...
  type CompendiumDocument = Actor | Actor<null> | Cards | Item | Item<null> | JournalEntry | Macro | Playlist | RollTable | Scene;
}

...
export declare const ASCII: `_______________________________________________________________
...
export declare const ACTIVE_EFFECT_MODES: {
    CUSTOM: 0;
    MULTIPLY: 1;
    ADD: 2;
    DOWNGRADE: 3;
 ...
 */
export declare const CARD_DRAW_MODES: {
    FIRST: 0;
    TOP: 0;
    LAST: 1;
    BOTTOM: 1;
...
export declare const CANVAS_PERFORMANCE_MODES: {
    LOW: 0;
    MED: 1;
    HIGH: 2;
    MAX: 3;
...
export declare const CORE_SUPPORTED_LANGUAGES: ["en"];
 ...
 */
export declare const COMPATIBILITY_MODES: {
    SILENT: 0;
    WARNING: 1;
    ERROR: 2;
    FAILURE: 3;
...
export declare const COMPENDIUM_DOCUMENT_TYPES: [
    "Actor",
    "Cards",
    "Item",
    "JournalEntry",
 ...
 */
export declare const DOCUMENT_OWNERSHIP_LEVELS: {
    INHERIT: -1;
    NONE: 0;
    LIMITED: 1;
    OBSERVER: 2;
...
export declare const DOCUMENT_META_OWNERSHIP_LEVELS: {
    DEFAULT: -20;
    NOCHANGE: -10;
};

/** Define the allowed Document types which may be dynamically linked in chat */
export declare const DOCUMENT_LINK_TYPES: [
    "Actor",
    "Cards",
    "Item",
    "Scene",
...
export declare const DICE_ROLL_MODES: {
    PUBLIC: "publicroll";
    PRIVATE: "gmroll";
    BLIND: "blindroll";
    SELF: "selfroll";
 ...
 */
export declare const DRAWING_FILL_TYPES: {
    NONE: 0;
    SOLID: 1;
    PATTERN: 2;
};
 ...
 */
export declare const FOLDER_DOCUMENT_TYPES: [
    "Actor",
    "Item",
    "Scene",
    "JournalEntry",
...
export declare const FOLDER_MAX_DEPTH: 3;

/** A list of allowed game URL names */
export declare const GAME_VIEWS: ["game", "stream"];

/** The minimum allowed grid size which is supported by the software */
export declare const GRID_MIN_SIZE: 50;

/** The allowed Grid types which are supported by the software */
export declare const GRID_TYPES: {
    GRIDLESS: 0;
    SQUARE: 1;
    HEXODDR: 2;
    HEXEVENR: 3;
...
export declare const SETUP_VIEWS: ["license", "setup", "players", "join", "auth"];

/** An Array of valid MacroAction scope values */
export declare const MACRO_SCOPES: ["global", "actors", "actor"];

/** An enumeration of valid Macro types */
export declare const MACRO_TYPES: {
    SCRIPT: "script";
    CHAT: "chat";
};
 ...
 */
export declare const PLAYLIST_MODES: {
    DISABLED: -1;
    SEQUENTIAL: 0;
    SHUFFLE: 1;
    SIMULTANEOUS: 2;
 ...
 */
export declare const PLAYLIST_SORT_MODES: {
    ALPHABETICAL: "a";
    MANUAL: "m";
};

/** The available modes for searching within a DirectoryCollection */
export declare const DIRECTORY_SEARCH_MODES: {
    FULL: "full";
    NAME: "name";
};

/** The allowed package types */
export declare const PACKAGE_TYPES: ["world", "system", "module"];

/** Encode the reasons why a package may be available or unavailable for use */
export declare const PACKAGE_AVAILABILITY_CODES: {
    UNKNOWN: -1;
    AVAILABLE: 0;
    REQUIRES_UPDATE: 1;
    REQUIRES_SYSTEM: 2;
...
export declare const SOFTWARE_UPDATE_CHANNELS: {
...
export declare const TABLE_RESULT_TYPES: {
    TEXT: 0;
    DOCUMENT: 1;
    COMPENDIUM: 2;
};
...
export declare const JOURNAL_ENTRY_PAGE_FORMATS: {
    HTML: 1;
    MARKDOWN: 2;
};

/** Define the valid anchor locations for a Tooltip displayed on a Placeable Object */
export declare const TEXT_ANCHOR_POINTS: {
    CENTER: 0;
    BOTTOM: 1;
    TOP: 2;
    LEFT: 3;
 ...
 */
export declare const TOKEN_DISPLAY_MODES: {
    NONE: 0;
    CONTROL: 10;
    OWNER_HOVER: 20;
    HOVER: 30;
...
export declare const MEASURED_TEMPLATE_TYPES: {
    CIRCLE: "circle";
    CONE: "cone";
    RECTANGLE: "rect";
    RAY: "ray";
 ...
 */
export declare const WALL_DIRECTIONS: {
    BOTH: 0;
    LEFT: 1;
    RIGHT: 2;
};
 ...
 */
export declare const WALL_DOOR_TYPES: {
    NONE: 0;
    DOOR: 1;
    SECRET: 2;
};
 ...
 */
export declare const WALL_DOOR_STATES: {
    CLOSED: 0;
    OPEN: 1;
    LOCKED: 2;
};
...
export declare const WALL_RESTRICTION_TYPES: ["light", "sight", "sound", "move"];
 ...
 */
export declare const WALL_SENSE_TYPES: {
    NONE: 0;
    LIMITED: 10;
    NORMAL: 20;
};
 ...
 */
export declare const WALL_MOVEMENT_TYPES: {
 ...
 */
export declare const KEYBINDING_PRECEDENCE: {
    PRIORITY: 0;
    NORMAL: 1;
    DEFERRED: 2;
};
...
export declare const HTML_FILE_EXTENSIONS: ["html", "handlebars", "hbs"];

/** The supported file extensions for image-type files, and their corresponding mime types. */
export declare const IMAGE_FILE_EXTENSIONS: {
    apng: "image/apng";
    avif: "image/avif";
    bmp: "image/bmp";
    gif: "image/gif";
...
export declare const VIDEO_FILE_EXTENSIONS: {
    m4v: "video/mp4";
    mp4: "video/mp4";
    ogg: "video/ogg";
    webm: "video/webm";
...
export declare const AUDIO_FILE_EXTENSIONS: {
    aac: "audio/aac";
    flac: "audio/flac";
    m4a: "audio/mp4";
    mid: "audio/midi";
...
export declare const FONT_FILE_EXTENSIONS: {
    ttf: "font/ttf";
    otf: "font/otf";
    woff: "font/woff";
    woff2: "font/woff2";
...
export declare const GRAPHICS_FILE_EXTENSIONS: {
...
export declare const UPLOADABLE_FILE_EXTENSIONS: typeof IMAGE_FILE_EXTENSIONS &
 ...
 */
export declare const MEDIA_MIME_TYPES: (typeof UPLOADABLE_FILE_EXTENSIONS)[keyof typeof UPLOADABLE_FILE_EXTENSIONS];

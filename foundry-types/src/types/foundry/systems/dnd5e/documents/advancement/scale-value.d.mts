...
declare class ScaleValueAdvancement extends Advancement {
     ...
     */
    static TYPES: {
        string: typeof import("../../data/advancement/scale-value").ScaleValueType;
        number: typeof import("../../data/advancement/scale-value").ScaleValueTypeNumber;
        cr: typeof import("../../data/advancement/scale-value").ScaleValueTypeCR;
        dice: typeof import("../../data/advancement/scale-value").ScaleValueTypeDice;
        distance: typeof import("../../data/advancement/scale-value").ScaleValueTypeDistance;
    };
    /** @inheritdoc */
    get levels(): any;
    /**

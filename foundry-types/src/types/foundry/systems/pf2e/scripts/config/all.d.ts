export const ConfigPF2e = {
  ...
  PF2E: {
      ...
      Character: {
        ...
        AttributeBuilder: {
          ...
          VoluntaryFlaw: {
            ...
            LegacyDescription:
              "This is the Voluntary Flaws feature that existed until the CRB's 4th printing. It is kept in place for older characters and as a continued option for Pathfinder Society play.",
      ...
      NPC: {
        ...
        Identification: {
          Skills: {
            ...
            Tooltip:
              '"The skill used to identify a creature usually depends on that creature’s trait, as shown on Table 10–7, but you have leeway on which skills apply." – CRB pg. 506',
          },
          Lore: {
    ...
    Age: "Age",
    AgeTitle: "The age of your character",
    Alignment: "Alignment",
    ...
    AncestryTitle: "Your character's ancestry",
    AreaLabel: "Area",
    AreaSize10: "10 Foot",
    ...
    ArmorGreaterStrikingRune: "Greater Striking",
    ...
    ArmorMajorStrikingRune: "Major Striking",
    ...
    ArmorPropertyRuneDread: "Lesser Dread",
    ...
    BackgroundTitle: "Your character's background",
    BaseModifier: "Base Modifier",
    BaseWeapons: "Base Weapons",
    BestiaryBrowserSearchHint:
      "You can search for name or custom attributes. Possible searchable attributes are:<br> source, spellType, level, school, components, materials, target, range, time, duration, damage, damageType, save, concentration, ritual, ability and classes. <br>Example: 'fire, damage:d6' to show all spells that have fire in their name and a d6 in the damage",
    Biography: "Biography",
    BiographyAllies: "Allies",
    BiographyAlliesTitle: "Your character's allies",
    BiographyAppearance: "Appearance",
    BiographyAppearanceTitle: "What your character looks like",
    BiographyAttitude: "Attitude",
    BiographyAttitudeTitle: "What your character behaves like",
    BiographyBackStory: "Backstory",
    BiographyBackStoryTitle: "Your character's story",
    BiographyBeliefs: "Beliefs",
    BiographyBeliefsTitle: "What your character believes",
    BiographyBirthPlace: "Birth Place",
    BiographyBirthPlaceTitle: "Where your character was born",
    BiographyCampaignNotes: "Notes",
    BiographyCampaignNotesHeader: "Campaign Notes",
    BiographyCampaignNotesTitle: "Anything you want",
    BiographyCatchphrases: "Catchphrases",
    BiographyCatchphrasesTitle: "Your character's catchphrases",
    BiographyDislikes: "Dislikes",
    BiographyDislikesTitle: "What your character dislikes",
    BiographyEnemies: "Enemies",
    BiographyEnemiesTitle: "Your character's enemies",
    BiographyLikes: "Likes",
    BiographyLikesTitle: "What your character likes",
    BiographyOrganizations: "Organizations",
    BiographyOrganizationsTitle: "Your character's organizations",
    BiographyPersonalityHeader: "Personality",
    Bonus: "Bonus",
    BonusBulk: "Bonus Bulk Maximum",
    BonusBulkTitle: "Add or subtract from your bulk limit",
    BonusEncumbranceBulkLabel: "Add Encumbered Bulk",
    ...
    BonusLimitBulkLabel: "Add Max Bulk",
    BonusSPLabel: "Bonus SP",
    BonusSPperLevel: "Bonus SP per Level",
    BonusSPperLevelTitle: "Applies once for every level (CON mod is added separately)",
    BrowseLabel: "Browse",
    ...
    ClassHP: "Class HP",
    ClassTitle: "Your character's class",
    ...
    CurrencyPP: "Platinum",
    CurrencySP: "Silver",
    CurrentHPTitle: "Your current hit points",
    ...
    Damage: {
      ...
      IWR: {
        ...
        CompositeLabel: {
          ...
          Exceptions4DoubleVs4:
            "{type} {value} (except {exception1}, {exception2}, {exception3}, or {exception4}; double resistance vs. {doubleVs1}, {doubleVs2}, {doubleVs3}, or {doubleVs4})",
        },
        Type: {
    ...
    Deity: "Deity",
    DeityTitle: "Your deity",
    DeleteConditionQuestion: "Are you sure you want to delete {condition}?",
    DeleteConditionTitle: "Delete Condition",
    DeleteItemQuestion: "Are you sure you want to delete:",
    ...
    Familiar: {
      ...
      MasterSpellcastingAbility: "Master Spellcasting Ability",
      Offenses: "Offenses",
    ...
    Feet: "feet",
    FlatBonusHP: "Flat Bonus HP",
    FlatBonusHPTitle: "Adds a static number to your HP",
    FlatBonusHPperLevel: "Bonus HP / Lvl",
    FlatBonusSP: "Flat Bonus SP",
    FlatBonusSPTitle: "Adds a static number to your SP",
    FlatBonusSPperLevel: "Bonus SP / Lvl",
    ...
    Focus: {
      ...
      label: "Focus Points",
      pointLabel: "Points",
      pointTitle: "Your remaining Focus Points",
      poolTitle: "The size of your Focus Pool",
    },
    Foot: "Foot",
    ...
    GenderPronounTitle: "Your gender/pronouns",
    ...
    HazardDescriptionTitle: "This explains what the hazard looks like and might include special rules",
    HazardDisableLabel: "Disable",
    HazardHardnessLabel: "Hardness",
    HazardHardnessTitle: "Hazard damage is reduced by this hardness value",
    HazardResetLabel: "Reset",
    HazardResetTitle: "If the hazard can be reset, that information is here",
    ...
    Heritage: "Heritage",
    HeritageTitle: "Your character's heritage",
    HeroPointRatio: {
    ...
    Item: {
      ...
      Deity: {
        ...
        Domain: {
          ...
          AirApocryphal: {
            Description:
              "You can control winds and the weather. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          AmbitionApocryphal: {
            Description:
              "You strive to keep up with and outpace the competition. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          ConfidenceApocryphal: {
            Description:
              "You overcome your fear and project pride. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          DarknessApocryphal: {
            Description:
              "You operate in the darkness and take away the light. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          DeathApocryphal: {
            Description:
              "You have the power to end lives and destroy undead. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          FateApocryphal: {
            Description:
              "You see and understand hidden inevitabilities. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          FireApocryphal: {
            Description:
              "You control flame. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          IndulgenceApocryphal: {
            Description:
              "You feast mightily and can shake off the effects of overindulging. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          KnowledgeApocryphal: {
            Description:
              "You receive divine insights. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          MightApocryphal: {
            Description:
              "Your physical power is bolstered by divine strength. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          SecrecyApocryphal: {
            Description:
              "You protect secrets and keep them hidden. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          TravelApocryphal: {
            Description:
              "You have power over movement and journeys. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
          ...
          WaterApocryphal: {
            Description:
              "You control water and bodies of water. Not all clerical traditions are taught among the orthodoxy. Some are whispered in secret, passed down from a priest to trusted acolytes or scribed in tomes left behind by splinter factions.",
      ...
      Physical: {
        ...
        FromSpell: {
          ...
          Scroll: "Scroll of {name} (Level {level})",
          Wand: "Wand of {name} (Level {level})",
        },
      ...
      Weapon: {
        ...
        CriticalSpecialization: {
          ...
          brawling:
            "The target must succeed at a @Check[type:fortitude|dc:resolve(@actor.attributes.classDC.value)|name:Brawling Critical Specialization] save or be @UUID[Compendium.pf2e.conditionitems.Item.xYTAsEpcJE1Ccni3]{Slowed 1} until the end of your next turn.",
          ...
          firearm:
            "The target must succeed at a @Check[type:fortitude|dc:resolve(@actor.attributes.classDC.value)|name:Firearm Critical Specialization] save or be @UUID[Compendium.pf2e.conditionitems.Item.dfCMdR4wnpbYNTix]{Stunned 1}.",
          ...
          knife:
            "The target takes @Localize[PF2E.PersistentDamage.Bleed1d6.success]. You gain an item bonus to this bleed damage equal to the weapon's item bonus to attack rolls.",
          ...
          sling:
            "The target must succeed at a @Check[type:fortitude|dc:resolve(@actor.attributes.classDC.value)|name:Sling Critical Specialization] save or be @UUID[Compendium.pf2e.conditionitems.Item.dfCMdR4wnpbYNTix]{Stunned 1}.",
          spear:
            "The weapon pierces the target, weakening its attacks. The target is @UUID[Compendium.pf2e.conditionitems.Item.i3OJZU2nk64Df3xm]{Clumsy 1} until the start of your next turn.",
          sword:
            "The target is made off-balance by your attack, becoming @UUID[Compendium.pf2e.conditionitems.Item.AJh5ex99aV6VTggg]{Off-Guard} until the start of your next turn.",
        },
        Damage: {
    ...
    MartialAdvanced: "Advanced Weapons",
    MartialHeavy: "Heavy Armor",
    MartialLight: "Light Armor",
    MartialMartial: "Martial Weapons",
    MartialMedium: "Medium Armor",
    MartialSimple: "Simple Weapons",
    MartialSkillsHeader: "Weapon and Armor Proficiencies",
    MartialUnarmed: "Unarmed",
    MartialUnarmored: "Unarmored",
    MasterAbility: {
      cha: "Master Charisma",
    ...
    Migrations: {
      ...
      Summary: {
        Documents: "Documents",
        HelpResources:
          'An unexpected error was encountered while migrating some actors or items. If you would like further assistance, feel free to report an issue at the <a href="https://github.com/foundryvtt/pf2e/issues">system repository</a> or visit us on <a href="https://discord.gg/SajryVzCyf">Discord</a> for community support.',
        Migrated: "Migrated",
        Remigrate: "Remigrate",
    ...
    NPC: {
      Abilities: {
        Glossary: {
          ...
          Ferocity:
            "<p><strong>Trigger</strong> The monster is reduced to 0 HP.</p>\n<hr />\n<p><strong>Effect</strong> The monster avoids being knocked out and remains at 1 HP, but its @UUID[Compendium.pf2e.conditionitems.Item.Yl48xTdMh3aeQYL2]{Wounded} value increases by 1. When it is Wounded 3, it can no longer use this ability</p>",
          FormUp:
            "<p>The troop chooses one of the squares it currently occupies and redistributes its squares to any configuration in which all squares are contiguous and within 15 feet of the chosen square. The troop can't share its space with other creatures.</p>",
          FrightfulPresence:
          ...
          ImprovedKnockdown:
            "<p>The monster can use @UUID[Compendium.pf2e.bestiary-ability-glossary-srd.Item.BCLvAx4Pz4MLa2pu]{Knockdown} as a free action triggered by a hit with its initial attack.</p>",
          ImprovedPush:
            "<p>The monster can use @UUID[Compendium.pf2e.bestiary-ability-glossary-srd.Item.t6cx9FOODmeZQNYl]{Push} as a free action triggered by a hit with its initial attack.</p>",
          Knockdown:
            "<p><strong>Requirements</strong> The monster's last action was a success with a Strike that lists Knockdown in its damage entry.</p>\n<hr />\n<p><strong>Effect</strong> The monster knocks the target @UUID[Compendium.pf2e.conditionitems.Item.j91X7x0XSomq8d60]{Prone}.</p>",
          Lifesense:
            "<p>Lifesense allows a monster to sense the vital essence of living and undead creatures within the listed range. The sense can distinguish between the positive energy animating living creatures and the negative energy animating undead creatures, much as sight distinguishes colors.</p>",
          LightBlindness:
            "<p>When first exposed to bright light, the monster is @UUID[Compendium.pf2e.conditionitems.Item.XgEqL1kFApUbl5Z2]{Blinded} until the end of its next turn. After this exposure, light doesn't blind the monster again until after it spends 1 hour in darkness. However, as long as the monster is in an area of bright light, it's @UUID[Compendium.pf2e.conditionitems.Item.TkIyaNPgTZFBCCuh]{Dazzled}.</p>",
          LowLightVision:
            "<p>The monster can see in dim light as though it were bright light, so it ignores the @UUID[Compendium.pf2e.conditionitems.Item.DmAIPqOBomZ7H95W]{Concealed} condition due to dim light.</p>",
          NegativeHealing:
            "<p>A creature with negative healing draws health from negative energy rather than positive energy. It is damaged by positive damage and is not healed by positive healing effects. It does not take negative damage, and it is healed by negative effects that heal undead.</p>",
          Poison:
            "<p>When a creature is exposed to a monster's poison, it attempts a Fortitude save to avoid becoming poisoned. The level of a poison is the level of the monster inflicting the poison. The poison follows the rules for afflictions.</p>",
          PowerAttack:
          ...
          SwarmMind:
            "<p>This monster doesn't have a single mind (typically because it's a swarm of smaller creatures), and is immune to mental effects that target only a specific number of creatures. It is still subject to mental effects that affect all creatures in an area.</p>",
          Telepathy:
      ...
      SkillsEditor: {
        ...
        SpecialCaseLabel: "Special case",
        TitleLabel: "NPC Skills Editor",
      },
    ...
    PreciousMaterialAdamantineDescription:
    ...
    PreciousMaterialColdIronDescription:
    ...
    PreciousMaterialDarkwoodDescription:
    ...
    PreciousMaterialGrisantianPeltDescription:
    ...
    PreciousMaterialInubrixDescription:
    ...
    PreciousMaterialKeepStoneDescription:
    ...
    PreciousMaterialNoqualDescription:
    ...
    PreciousMaterialPeachwoodDescription:
    ...
    PreciousMaterialSilverDescription:
    ...
    PreciousMaterialSisterstoneDescription:
    ...
    PreciousMaterialWarpglassDescription:
    ...
    SETTINGS: {
      Automation: {
        ActorsDeadAtZero: {
          Both: "PCs and NPCs",
          Hint: "Upon reaching zero hit points, NPCs are marked as dead.",
          NPCsOnly: "Yes",
          Name: "NPCs dead at 0 HP",
          Neither: "No",
          PCsOnly: "PCs only",
        },
        Encumbrance: {
      ...
      Player: {
        QuickRolls: {
          DialogHint: "Always show this window before attempting checks.",
        },
      },
      ...
      Variant: {
        ...
        AutomaticBonus: {
          ...
          Name: "Automatic Bonus Variant Rules",
    ...
    Senses: "Senses",
    SettingsColorBlue: "Bluegray",
    "SettingsColorFoundry-UI": "Work in Progress",
    SettingsColorLabel: "UI Theme",
    SettingsColorNotes: "UI themes are most visible on the sidebar and chat cards.",
    SettingsColorOriginal: "Original",
    SettingsColorRed: "Darkred",
    SettingsDataUriHighlightLabel: "Highlight images that use data: URI",
    SettingsDataUriHighlightNotes:
      "Images that use a data: URI are embedded in the character sheet. This has a negative performance impact on the character. If enabled, such images will be highlighted with a red border to make it easy to find and remove them.<br>This setting is only active for the current session.",
    SettingsQuickRollsLabel: "Preview D20 Rolls",
    SettingsQuickRollsNotes: "If disabled, dialogs to preview D20 rolls will appear only when a roll button is shift-clicked.",
    SheetLabel: "{type} Sheet",
    SheetLabelDataEntry: "{type} Sheet (data entry)",
    SheetLabelNew: "{type} Sheet (preview)",
    SheetLabelOld: "{type} Sheet (legacy)",
    ShieldACBonusTitle: "The AC bonus of your shield (when you use the raise shield action)",
    ShieldBTShortLabel: "BT",
    ShieldBTTitle: "Your shield's Broken Threshold",
    ShieldBrokenThresholdLabel: "Broken Threshold",
    ShieldCurrentLabel: "Shield HP",
    ShieldCurrentTitle: "Your shield's current Hit Points",
    ShieldHardnessLabel: "Hardness",
    ShieldHardnessShortLabel: "H",
    ShieldHardnessTitle: "Shield damage is reduced by this hardness value",
    ShieldLabel: "Shield",
    ShieldMaxLabel: "Max",
    ShieldMaxTitle: "Your shield's max Hit Points",
    ...
    SpeedTitle: "Your character's speed",
    ...
    SpeedTypesLand: "Land",
    SpeedTypesSwim: "Swim",
    SpeedTypesTitle: "Alternative movement types",
    SpellAbilityLabel: "Key Attribute",
    SpellAbilityModLabel: "+ Mod",
    SpellArea: "Area: {areaSize} {areaUnit} {areaType}",
    ...
    SpellLevel1: "1st Level",
    SpellLevel10: "10th Level",
    SpellLevel2: "2nd Level",
    SpellLevel3: "3rd Level",
    SpellLevel4: "4th Level",
    SpellLevel5: "5th Level",
    SpellLevel6: "6th Level",
    SpellLevel7: "7th Level",
    SpellLevel8: "8th Level",
    SpellLevel9: "9th Level",
    SpellLevelBase: "Base: {level}",
    SpellLevelHeightened: "Heightened: +{heightened}",
    SpellLevelLabel: "Spell Level",
    SpellNonCantripLabel: "Non-Cantrip",
    ...
    SpellcastingSettings: {
      ...
      AutoHeightenLabel: "Auto Heighten Level",
    ...
    StatusEffects: "{name}'s status effects:",
    StealthLabel: "Stealth",
    Strike: {
      Combined: {
        Description:
          "You attack with a weapon you&apos;re wielding, targeting one creature within your reach (for a melee attack) or within range (for a ranged attack). Roll the attack roll for the weapon or unarmed attack you are using, and compare the result to the target creature&apos;s AC to determine the effect.",
      ...
      Melee: {
        Description:
          "You attack with a weapon you&apos;re wielding, targeting one creature within your reach. Roll the attack roll for the weapon you are using, and compare the result to the target creature&apos;s AC to determine the effect.",
        Success: "You deal damage according to the weapon, including any modifiers, bonuses, and penalties you have to damage.",
      },
      Ranged: {
        Description:
          "You attack with a weapon you&apos;re wielding, targeting one creature within range. Roll the attack roll for the weapon you are using, and compare the result to the target creature&apos;s AC to determine the effect.",
        NoAmmo: "No ammunition is assigned to {weapon}. Check the Actions tab of {actor}'s sheet.",
        Success: "You deal damage according to the weapon, including any modifiers, bonuses, and penalties you have to damage.",
      },
      Unarmed: {
        Description:
          "You attack with an unarmed attack, targeting one creature within your reach. Roll the attack roll for the unarmed attack you are using, and compare the result to the target creature&apos;s AC to determine the effect.",
    ...
    ToggleSlotlessSpellLevelsTitle: "Toggle visibility of spell levels without slots",
    ...
    TraitDescriptionCobbled:
      "This firearm is cobbled together and likely to misfire. No matter how well you upkeep it, on a failed attack roll, the attack misses and you must roll a @Check[type:flat|dc:5]. If you fail this check, the weapon misfires.",
    TraitDescriptionCoda:
    ...
    TraitDescriptionExtradimensional:
    ...
    TraitDescriptionIncapacitation:
    ...
    TraitDescriptionLinguistic:
      "An effect with this trait depends on language comprehension. A linguistic effect that targets a creature works only if the target understands the language you are using.",
    TraitDescriptionLitany:
    ...
    TraitDescriptionNegative: "Effects with this trait heal undead creatures with negative energy, deal negative damage to living creatures, or manipulate negative energy.",
    TraitDescriptionNoisy:
    ...
    TraitDescriptionPeachwood:
      "Peachwood weapons have a particularly auburn tinge to them when under direct sunlight. Peachwood is treated as darkwood for any undead creatures' resistances or weaknesses related to darkwood (allowing a peachwood weapon to bypass a jiang-shi's resistance, for example). In addition, peachwood weapons bypass a small portion of the resistances of any undead creature. Strikes with a peachwood weapon treat an undead's resistances against physical damage as 2 lower for standard-grade peachwood, and 4 lower for high-grade.",
    TraitDescriptionPlant:
    ...
    TraitDescriptionPositive: "Effects with this trait heal living creatures with positive energy, deal positive energy damage to undead, or manipulate positive energy.",
    TraitDescriptionPossession:
    ...
    TraitDescriptionSubjectiveGravity:
    ...
    TraitRange100: "Range 100 ft",
    TraitRange110: "Range 110 ft",
    TraitRange120: "Range 120 ft",
    TraitRange130: "Range 130 ft",
    TraitRange140: "Range 140 ft",
    TraitRange15: "Range 15 ft",
    TraitRange150: "Range 150 ft",
    TraitRange160: "Range 160 ft",
    TraitRange170: "Range 170 ft",
    TraitRange180: "Range 180 ft",
    TraitRange190: "Range 190 ft",
    TraitRange20: "Range 20 ft",
    TraitRange200: "Range 200 ft",
    TraitRange210: "Range 210 ft",
    TraitRange220: "Range 220 ft",
    TraitRange230: "Range 230 ft",
    TraitRange240: "Range 240 ft",
    TraitRange25: "Range 25 ft",
    TraitRange250: "Range 250 ft",
    TraitRange260: "Range 260 ft",
    TraitRange270: "Range 270 ft",
    TraitRange280: "Range 280 ft",
    TraitRange290: "Range 290 ft",
    TraitRange30: "Range 30 ft",
    TraitRange300: "Range 300 ft",
    TraitRange310: "Range 310 ft",
    TraitRange320: "Range 320 ft",
    TraitRange40: "Range 40 ft",
    TraitRange5: "Range 5 ft",
    TraitRange50: "Range 50 ft",
    TraitRange500: "Range 500 ft",
    TraitRange60: "Range 60 ft",
    TraitRange70: "Range 70 ft",
    TraitRange80: "Range 80 ft",
    TraitRange90: "Range 90 ft",
    TraitRangeIncrement10: "Range Increment 10 ft",
    TraitRangeIncrement100: "Range Increment 100 ft",
    TraitRangeIncrement110: "Range Increment 110 ft",
    TraitRangeIncrement120: "Range Increment 120 ft",
    TraitRangeIncrement130: "Range Increment 130 ft",
    TraitRangeIncrement140: "Range Increment 140 ft",
    TraitRangeIncrement15: "Range Increment 15 ft",
    TraitRangeIncrement150: "Range Increment 150 ft",
    TraitRangeIncrement160: "Range Increment 160 ft",
    TraitRangeIncrement170: "Range Increment 170 ft",
    TraitRangeIncrement180: "Range Increment 180 ft",
    TraitRangeIncrement190: "Range Increment 190 ft",
    TraitRangeIncrement20: "Range Increment 20 ft",
    TraitRangeIncrement200: "Range Increment 200 ft",
    TraitRangeIncrement210: "Range Increment 210 ft",
    TraitRangeIncrement220: "Range Increment 220 ft",
    TraitRangeIncrement230: "Range Increment 230 ft",
    TraitRangeIncrement240: "Range Increment 240 ft",
    TraitRangeIncrement25: "Range Increment 25 ft",
    TraitRangeIncrement250: "Range Increment 250 ft",
    TraitRangeIncrement260: "Range Increment 260 ft",
    TraitRangeIncrement270: "Range Increment 270 ft",
    TraitRangeIncrement280: "Range Increment 280 ft",
    TraitRangeIncrement290: "Range Increment 290 ft",
    TraitRangeIncrement30: "Range Increment 30 ft",
    TraitRangeIncrement300: "Range Increment 300 ft",
    TraitRangeIncrement310: "Range Increment 310 ft",
    TraitRangeIncrement320: "Range Increment 320 ft",
    TraitRangeIncrement40: "Range Increment 40 ft",
    TraitRangeIncrement5: "Range Increment 5 ft",
    TraitRangeIncrement50: "Range Increment 50 ft",
    TraitRangeIncrement60: "Range Increment 60 ft",
    TraitRangeIncrement70: "Range Increment 70 ft",
    TraitRangeIncrement75: "Range Increment 75 ft",
    TraitRangeIncrement80: "Range Increment 80 ft",
    TraitRangeIncrement90: "Range Increment 90 ft",
    ...
    TraitRazing: "Razing",
    TraitReach: "Reach",
    TraitReach0: "Reach 0 ft",
    TraitReach10: "Reach 10 ft",
    TraitReach100: "Reach 100 ft",
    TraitReach120: "Reach 120 ft",
    TraitReach1000: "Reach 1,000 ft",
    TraitReach15: "Reach 15 ft",
    TraitReach20: "Reach 20 ft",
    TraitReach200: "Reach 200 ft",
    TraitReach25: "Reach 25 ft",
    TraitReach30: "Reach 30 ft",
    TraitReach40: "Reach 40 ft",
    TraitReach50: "Reach 50 ft",
    TraitReach60: "Reach 60 ft",
    ...
    TraitVersatileNegative: "Versatile Negative",
    TraitVersatileP: "Versatile P",
    TraitVersatilePoison: "Versatile Poison",
    TraitVersatilePositive: "Versatile Positive",
    ...
    UI: {
      ...
      errorTargetToken: "Select at least one token.",
      warnNoActor: "This inline roll requires an actor.",
      noDamageInfoForOutcome: "No damage information for outcome {outcome}.",
      shiftModifyDamageLabel: "Adjust Damage/Healing",
      shiftModifyDamageTitle: "Adjust the rolled damage/healing",
    },
    UUID: {
      Label: "UUID",
      SourceId: "Source ID",
    ...
    UnitedPaizoWorkers: {
      PFSNote:
        'Note for Pathfinder Society players: In support of UPW, merchandise purchased from the union store will count in the Online PFS region for the <span class="hover" title="When you use a Hero Point to reroll a check, add a +1 cirumstance bonus to the reroll">Promotional Vestments</a> boon.',
      ReleaseIntro:
    ...
    WeaponBaseDamageTitle:
      "This section configures the base damage for the weapon. Additional die from Striking runes should not be added here and instead configured in the Weapon Runes section above.",
    ...
    WeaponCustomDamageTitle:
      "This section adds any custom damage that is not covered by the Rune system. The Strike Effect and Critical Effect attributes are not currently used in the system and are informational only.",
    ...
    WeaponPropertyRune: {
      anarchic: {
        ...
        Note: {
          criticalSuccess:
            "When you critically succeed at a Strike with this weapon against a lawful creature, roll [[/r 1d6 #Anarchic Rune]]. On a 1 or 2, you deal double minimum damage; on a 3 or 4, double your damage normally; on a 5 or 6, you deal double maximum damage.",
        },
      },
      ancestralEchoing: {
      ...
      anchoring: {
        ...
        Note: {
          criticalSuccess:
            "If you critically hit a target with an anchoring weapon, the weapon casts <em>@UUID[Compendium.pf2e.spells-srd.Item.ksLCg62cLOojw3gN]{Dimensional Anchor}</em> on the target (@Check[type:will|dc:27|name:Anchoring Rune], counteract modifier [[/r 1d20+17 # Anchoring Rune Counteract Check]]{+17}).",
        },
      },
      ashen: {
        Name: "Ashen",
      ...
      bloodthirsty: {
        ...
        Note: {
          criticalSuccess:
            "When you critically hit a target that's taking @UUID[Compendium.pf2e.conditionitems.Item.lDVqvLKA6eF3Df60]{Persistent Bleed Damage}, your target becomes @UUID[Compendium.pf2e.conditionitems.Item.4D2KBtexWXa6oUMR]{Drained 1}.",
        },
      },
      brilliant: {
        Name: "Brilliant",
        Note: {
          criticalSuccess:
            "On a critical hit, the target must succeed at a @Check[type:fortitude|dc:29|name:Brilliant Rune] save or be @UUID[Compendium.pf2e.conditionitems.Item.XgEqL1kFApUbl5Z2]{Blinded} for 1 round.",
        },
      },
      called: {
        Name: "Called",
      ...
      corrosive: {
        ...
        Note: {
          criticalSuccess:
            "On a critical hit, the target's armor (if any) takes [[/r 3d6[acid] #Corrosive Rune]]{3d6 acid} damage (before applying Hardness); if the target has a shield raised, the shield takes this damage instead.",
        },
      },
      crushing: {
        Name: "Crushing",
      ...
      frost: {
        ...
        Note: {
          criticalSuccess:
            "On a critical hit, the target is also @UUID[Compendium.pf2e.conditionitems.Item.xYTAsEpcJE1Ccni3]{Slowed 1} until the end of your next turn unless it succeeds at a @Check[type:fortitude|dc:24|name:Frost Rune] save.",
        },
      },
      ghostTouch: {
        Name: "Ghost Touch",
      ...
      greaterAshen: {
        ...
        Note: {
          success:
            "This ash clouds the senses, causing the creature to become confused for 1 round unless it succeeds at a @Check[type:will|dc:35] save. On a critical failure, the effect lasts for 1 minute.",
        },
      },
      greaterBloodbane: {
      ...
      greaterBrilliant: {
        ...
        Note: {
          criticalSuccess:
            "Damage dealt by this weapon ignores the target's fire, good, or positive resistance. On a critical hit, the target must succeed at a @Check[type:fortitude|dc:41|name:Greater Brilliant Rune] save or be @UUID[Compendium.pf2e.conditionitems.Item.XgEqL1kFApUbl5Z2]{Blinded} for 1 round.",
          success: "<strong>Greater Brilliant Rune</strong> Damage dealt by this weapon ignores the target's fire, good, or positive resistance.",
        },
      },
      greaterCorrosive: {
        ...
        Note: {
          criticalSuccess:
            "The acid damage dealt by this weapon ignores the target's acid resistance. On a critical hit, the target's armor (if any) takes [[/r 6d6[acid]]]{6d6 acid} damage (before applying Hardness); if the target has a shield raised, the shield takes this damage instead.",
          success: "<strong>Greater Corrosive Rune</strong> The acid damage dealt by this weapon ignores the target's acid resistance.",
        },
      },
      greaterCrushing: {
        ...
        Note: {
          criticalSuccess:
            "Your critical hits leave the target @UUID[Compendium.pf2e.conditionitems.Item.i3OJZU2nk64Df3xm]{Clumsy 2} and @UUID[Compendium.pf2e.conditionitems.Item.MIRkyAjyBeXivMa7]{Enfeebled 2} until the end of your next turn. @UUID[Compendium.pf2e.equipment-effects.Item.czdEHtLsrUcZxSDx]{Effect: Crushing (Greater)}",
        },
      },
      greaterDisrupting: {
      ...
      greaterFrost: {
        ...
        Note: {
          criticalSuccess:
            "Cold damage dealt by this weapon ignores the target's cold resistance. On a critical hit, the target is also @UUID[Compendium.pf2e.conditionitems.Item.xYTAsEpcJE1Ccni3]{Slowed 1} until the end of your next turn unless it succeeds at a @Check[type:fortitude|dc:34|name:Greater Frost Rune] save.",
          success: "<strong>Greater Frost Rune</strong> Cold damage dealt by this weapon ignores the target's cold resistance.",
        },
      },
      greaterHauling: {
      ...
      greaterImpactful: {
        ...
        Note: {
          criticalSuccess:
            "On a critical hit, you can choose to force the target to succeed at a @Check[type:fortitude|dc:37|name:Greater Impactful Rune] save or be pushed 10 feet away from you.",
        },
      },
      greaterShock: {
        Name: "Greater Shock",
        Note: {
          criticalSuccess:
            "Electricity damage dealt by this weapon ignores the targets electricity resistance (and the other creatures' on a critical hit). On a critical hit, electricity arcs out to deal an equal amount of electricity damage to up to two other creatures of your choice within 10 feet of the target.",
      ...
      greaterThundering: {
        ...
        Note: {
          criticalSuccess:
            "Sonic damage dealt by this weapon ignores the target's sonic resistance. On a critical hit, the target has to succeed at a @Check[type:fortitude|dc:34|name:Greater Thundering Rune] save or be @UUID[Compendium.pf2e.conditionitems.Item.9PR9y0bi4JPKnHPR]{Deafened} permanently.",
      ...
      holy: {
        ...
        Note: {
          criticalSuccess:
            '(<span class="pf2-icon">R</span> command; once per day)<br /><strong>Trigger</strong> You critically succeed at an attack roll against an evil creature with the weapon<br /><strong>Effect</strong> You regain HP equal to double the evil creature\'s level. This is a good, positive, healing effect.',
        },
      },
      hopeful: {
        Name: "Hopeful",
        Note: {
          criticalSuccess:
            "On a critical hit with this weapon, you inspire your comrades, pushing them to fight harder and stand for your shared convictions. Allies within 30 feet that share at least one alignment component with you gain a +1 status bonus to attack rolls until the end of your next turn.",
        },
      },
      impactful: {
        Name: "Impactful",
        Note: {
          criticalSuccess:
            "On a critical hit, you can choose to force the target to succeed at a @Check[type:fortitude|dc:27|name:Impactful Rune] save or be pushed 5 feet away from you.",
        },
      },
      impossible: {
        Name: "Impossible",
      ...
      keen: {
        Name: "Keen",
        Note: "Attacks with this weapon are a critical hit on a 19 on the die as long as that result is a success. This property has no effect on a 19 if the result would be a failure.",
      },
      kinWarding: {
        Name: "Kin-Warding",
      },
      ...
      returning: {
        Name: "Returning",
        Note: "<strong>Returning Rune</strong> When you make a thrown Strike with this weapon, it flies back to your hand after the Strike is complete. If your hands are full when the weapon returns, it falls to the ground in your space.",
      },
      serrating: {
        Name: "Serrating",
      },
      ...
      thundering: {
        ...
        Note: {
          criticalSuccess:
            "On a critical hit, the target has to succeed at a @Check[type:fortitude|dc:24|name:Thundering Rune] save or be @UUID[Compendium.pf2e.conditionitems.Item.9PR9y0bi4JPKnHPR]{Deafened} for 1 minute (or 1 hour on a critical failure).",
        },
      },
      underwater: {
        Name: "Underwater",
    ...
    condition: {
      ...
      clumsy: {
        name: "Clumsy",
        rules:
          "<p>Your movements become clumsy and inexact. Clumsy always includes a value. You take a status penalty equal to the condition value to Dexterity-based checks and DCs, including AC, Reflex saves, ranged attack rolls, and skill checks using Acrobatics, Stealth, and Thievery.</p>",
        summary: "You can't move as easily or gracefully as usual.",
      },
      concealed: {
        name: "Concealed",
        rules:
          "<p>While you are concealed from a creature, such as in a thick fog, you are difficult for that creature to see. You can still be observed, but you're tougher to target. A creature that you're concealed from must succeed at a @Check[type:flat|dc:5] when targeting you with an attack, spell, or other effect.</p>\n<p>Area effects aren't subject to this flat check. If the check fails, the attack, spell, or effect doesn't affect you.</p>",
      ...
      encumbered: {
        name: "Encumbered",
        rules:
          "<p>You are carrying more weight than you can manage. While you're encumbered, you're clumsy 1 and take a 10-foot penalty to all your Speeds. As with all penalties to your Speed, this can't reduce your Speed below 5 feet.</p>",
        summary: "You're carrying more weight than you can manage.",
      },
      enfeebled: {
        name: "Enfeebled",
        rules:
          "<p>You're physically weakened. Enfeebled always includes a value. When you are enfeebled, you take a status penalty equal to the condition value to Strength-based rolls and DCs, including Strength-based melee attack rolls, Strength-based damage rolls, and Athletics checks.</p>",
      ...
      fatigued: {
        name: "Fatigued",
        rules:
          "<p>You're tired and can't summon much energy. You take a -1 status penalty to AC and saving throws. While exploring, you can't choose an exploration activity.</p>\n<p>You recover from fatigue after a full night's rest.</p>",
      ...
      grabbed: {
        name: "Grabbed",
        rules:
          "<p>You're held in place by another creature, giving you the off-guard and immobilized conditions. If you attempt a manipulate action while grabbed, you must succeed at a @Check[type:flat|dc:5] or it is lost; roll the check after spending the action, but before any effects are applied.</p>",
      ...
      restrained: {
        name: "Restrained",
        rules:
          "<p>You're tied up and can barely move, or a creature has you pinned. You have the off-guard and immobilized conditions, and you can't use any actions with the attack or manipulate traits except to attempt to Escape or Force Open your bonds. Restrained overrides grabbed.</p>",
        summary: "You're tied up and can't move, or a grappling creature has you pinned.",
      },
      sickened: {
        name: "Sickened",
        rules:
          "<p>You feel ill. Sickened always includes a value. You take a status penalty equal to this value on all your checks and DCs. You can't willingly ingest anything-including elixirs and potions-while sickened.</p>\n<p>You can spend a single action retching in an attempt to recover, which lets you immediately attempt a Fortitude save against the DC of the effect that made you sickened. On a success, you reduce your sickened value by 1 (or by 2 on a critical success).</p>",
      ...
      unnoticed: {
        name: "Unnoticed",
        rules:
          "<p>If you are unnoticed by a creature, that creature has no idea you are present at all. When you're unnoticed, you're also undetected by the creature. This condition matters for abilities that can be used only against targets totally unaware of your presence.</p>",
    ...
    ui: {
      ...
      equipmentInvested: "Toggle investing your equipment",
      sell: "Sell",
    ...
    vehicle: {
      ...
      PropertyDescriptionPilotingCheck:
        "This entry lists the skills that can be used for piloting checks while operating the vehicle. Some skills may increase the DC; these list the DC adjustment in parentheses following the skill name.",
      ...
      PropertyDescriptionSpeed:
        "The vehicle's Speeds, each followed by the propulsion type for that Speed in parentheses. A pulled vehicle indicates the number and size of the pulling creatures.",

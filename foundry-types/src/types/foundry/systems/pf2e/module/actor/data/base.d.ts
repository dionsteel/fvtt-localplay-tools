...
import { Rolled } from "../../../../../client/roll.js";
...
interface ActorSystemSource {
  details?: ActorDetailsSource & any;
...
interface ActorDetailsSource extends Record<string, any> {
  level?: {
    value: number;
  };
...
interface ActorTraitsSource<TTrait extends string> extends Record<string | number | symbol, any> {

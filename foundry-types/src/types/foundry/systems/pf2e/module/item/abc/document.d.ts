...
import type { AncestrySource, AncestrySystemData } from "src/types/foundry/systems/pf2e/module/item/ancestry/data.ts";
import type { BackgroundSource, BackgroundSystemData } from "src/types/foundry/systems/pf2e/module/item/background/data.ts";
import type { ClassSource, ClassSystemData } from "src/types/foundry/systems/pf2e/module/item/class/data.ts";

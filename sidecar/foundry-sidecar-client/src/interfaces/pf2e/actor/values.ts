...
declare const IMMUNITY_TYPES: Set<
  | "adamantine"
  | "auditory"
  | "blinded"
  | "clumsy"
  ...
  | "swarm-mind"
>;
declare const WEAKNESS_TYPES: Set<
  | "adamantine"
  | "darkwood"
  | "emotion"
  | "energy"
...
>;
declare const RESISTANCE_TYPES: Set<
  | "adamantine"
  | "darkwood"
  | "energy"
  | "light"
...
declare const SKILL_LONG_FORMS: Set<
  | "athletics"
  | "deception"
  | "stealth"
  | "nature"

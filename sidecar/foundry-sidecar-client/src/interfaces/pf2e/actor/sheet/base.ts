import type { ActorPF2e } from "@/interfaces/pf2e/actor";
import { StrikeData } from "@/interfaces/pf2e/actor/data/base";
import { ItemPF2e } from "@/interfaces/pf2e/item";
import { ItemSourcePF2e } from "@/interfaces/pf2e/item/data/index";
import { Coins } from "@/interfaces/pf2e/item/physical";
// import { DropCanvasItemDataPF2e } from "@/interfaces/pf2e/system/";
// import { BasicConstructorOptions, TagSelectorOptions, TagSelectorType } from "@/interfaces/pf2e/system/";
import { ActorSheetDataPF2e, ActorSheetRenderOptionsPF2e, CoinageSummary, SheetInventory } from "./data-types.js";
 ...
 * @category Actor
 */
declare abstract class ActorSheetPF2e<TActor extends ActorPF2e> {
  // #private;
   ...
   */
  moveItemBetweenActors(event: any, sourceActorId: string, sourceTokenId: string | null, targetActorId: string, targetTokenId: string | null, itemId: string): Promise<void>;
...
interface ActorSheetPF2e<TActor extends ActorPF2e> {
  prepareItems?(sheetData: ActorSheetDataPF2e<TActor>): Promise<void>;
}
export type { ActorSheetPF2e };

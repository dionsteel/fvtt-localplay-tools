...
import { DexterityModifierCapData } from "../../actor/character/index";
import { Abilities } from "../../actor/creature";
import { ActorSizePF2e } from "../../actor/data/size";
import { StatisticModifier } from "../../actor/modifiers";
import { AbilityString, ActorAlliance, SkillLongForm } from "../../actor/index";
import { ConsumablePF2e, MeleePF2e, WeaponPF2e } from "../../item/index";
import { ItemSourcePF2e } from "../../item/data/index";
import { DocumentSchemaRecord, Rarity, Size, ValueAndMaybeMax, ZeroToTwo } from "../../data";
// import { AutoChangeEntry } from "../../rules/rule-element";
import { AttackRollParams, DamageRollParams, RollParameters } from "../../system/rolls";
import { CheckRoll } from "../../system/roll";
...
import { PrototypeToken } from "@/interfaces/core";
...
interface BaseActorSourcePF2e<TType extends ActorType, TSystemSource extends ActorSystemSource = ActorSystemSource> {
  flags: PartialDeep<ActorFlagsPF2e>;
...
interface ActorSystemData extends ActorSystemSource {
  ...
  autoChanges: Record<string, any[] | undefined>;
}
...
type RollFunction<T extends RollParameters = RollParameters> = (params: T) => Promise<CheckRoll | null | string | void>;
type DamageRollFunction = (params?: DamageRollParams) => Promise<string | DamageRoll | null>;
...
interface StrikeData extends StatisticModifier {
  ...
  ammunition?: {
    compatible: (ConsumablePF2e | WeaponPF2e)[];
    incompatible: (ConsumablePF2e | WeaponPF2e)[];
    selected: {
      id: string;
      compatible: boolean;
    } | null;
...
interface PrototypeTokenSourcePF2e {
  flags: PrototypeToken["flags"] & {
    pf2e?: {
...
interface PrototypeTokenPF2e<TParent extends ActorPF2e | null> extends PrototypeToken {
  flags: PrototypeToken["flags"] & {
    pf2e: {
      linkToActorSize: boolean;
      autoscale: boolean;

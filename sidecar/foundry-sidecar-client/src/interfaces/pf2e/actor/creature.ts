...
import { DamageDicePF2e, ModifierPF2e, RawModifier, StatisticModifier } from "./modifiers";
import type { AbilityString, ActorAlliance, MovementType, SaveType, SkillAbbreviation, SkillLongForm } from "./index";
import type { CREATURE_ACTOR_TYPES } from "./values";
import { LabeledNumber, Size, ValueAndMax, ValuesList, ZeroToThree } from "../data";
import { StatisticTraceData } from "../system/statistic";
import { CreatureSensePF2e, SenseAcuity, SenseType } from "./creature/sense";
import { Alignment, CreatureTrait } from "./creature/index";
...
type SaveData = StatisticTraceData &
  AbilityBasedStatistic & {
    saveDetail?: string;
  };
...
export interface CreaturePF2e extends ActorPF2e{

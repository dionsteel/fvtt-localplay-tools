...
import { DCSlug } from "@/interfaces/pf2e/actor/index";
import { ZeroToThree } from "@/interfaces/pf2e/data";
// import { CheckRoll } from "./check/index";
// import { PredicatePF2e } from "./index";
import { StatisticDifficultyClassData } from "./statistic";
type CheckRoll=any;
type Rolled<T> = T;
type PredicatePF2e = any;
...
interface CheckDC {
  slug?: DCSlug | null;
  statistic?: StatisticDifficultyClassData | StatisticModifier | null;
  label?: string;
  scope?: "attack" | "check";
  value: number;
  visible?: boolean;

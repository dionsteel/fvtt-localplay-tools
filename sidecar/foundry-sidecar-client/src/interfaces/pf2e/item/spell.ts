...
import { OneToTen, TraitsWithRarity, ValueAndMax } from "@/interfaces/pf2e/data";
import { MaterialDamageEffect, DamageCategoryUnique, DamageType } from "@/interfaces/pf2e/system/damage/index";
import { EffectAreaSize, EffectAreaType, MagicTradition, SpellComponent, SpellTrait } from "./spell/index";
...
interface SpellOverlayOverride {
  _id: string;
  system: PartialDeep<SpellSystemSource>;
  name?: string;

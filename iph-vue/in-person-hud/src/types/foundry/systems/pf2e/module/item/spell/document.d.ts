...
import { ItemSourcePF2e, ItemSummaryData } from "src/types/pf2e/module/item/data/index.ts";
...
import { MeasuredTemplatePF2e } from "src/types/pf2e/module/canvas/index.ts";
import { ChatMessagePF2e, ItemOriginFlag } from "src/types/pf2e/module/chat-message/index.ts";
import { OneToTen, ZeroToTwo } from "src/types/pf2e/module/data.ts";
...
import { DamageRollContext, SpellDamageTemplate } from "src/types/pf2e/module/system/damage/types.ts";
import { StatisticRollParameters } from "src/types/pf2e/module/system/statistic/index.ts";
import { EnrichHTMLOptionsPF2e } from "src/types/pf2e/module/system/text-editor.ts";

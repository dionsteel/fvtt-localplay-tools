...
const FVTT_COMMON_LIB_VERSION = "1.0";
...
function AutoLogin(username = 'MapTable', password = '', gmlogin = false, autologin = true) {
            ...
            try {
                if (isGameInitialised(game)) {
                    ...
                    if (autologin &&
                        ...
                        let loginAppForm = loginApp.form;
                        if (gmlogin) {
...
exports.FVTT_COMMON_LIB_VERSION = FVTT_COMMON_LIB_VERSION;
exports.isGameInitialised = isGameInitialised;
//# sourceMappingURL=preload_deps.js.map

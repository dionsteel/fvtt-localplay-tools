...
import { Actor5e, TokenDocument5e } from "src/types/dnd5e/module/documents/_module.mjs";
import {
  Background5e,
  ClassItem5e,
  ConsumableItem5e,
...
export interface Actor5E<S extends ActorSystemTypes = ActorSystemTypes> extends Actor5e<S, TokenDocument5e> {
  id:string;
  name:string;
  img: ImageFilePath;
  itemTypes: ItemTypes;

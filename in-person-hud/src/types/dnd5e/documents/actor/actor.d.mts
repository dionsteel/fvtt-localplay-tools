import CharacterData from "../../module/data/actor/character.d.mts";

/**
 * Extend the base Actor class to implement additional system-specific logic.
 */
export default class Actor5e extends Actor<TokenDocument5e<Scene | null> | null> {
  /**
   ...
   */
  getInitiativeRoll(options?: { advantageMode?: D20Roll.ADV_MODE; flavor?: string }): D20Roll;
  /**
   ...
   */
  rollNPCHitPoints({ chatMessage }?: { chatMessage?: boolean }): Promise<Roll>;
  /**
   ...
   */
  autoSpendHitDice({ threshold }?: { threshold?: number }): Promise<number>;
  /**
   ...
   * @protected
   */
  protected _getRestHitPointRecovery({ recoverTemp, recoverTempMax }?: { recoverTemp?: boolean; recoverTempMax?: boolean }): object;
  /**
   ...
   * @protected
   */
  protected _getRestSpellRecovery({ recoverPact, recoverSpells }?: { recoverPact?: boolean; recoverSpells?: boolean }): object;
  /**
   ...
   * @protected
   */
  protected _getRestHitDiceRecovery({ maxHitDice }?: { maxHitDice?: number }): object;
  /**
   ...
   */
  revertOriginalForm({ renderSheet }?: { renderSheet?: boolean }): Promise<Actor> | null;
  /** @inheritdoc */

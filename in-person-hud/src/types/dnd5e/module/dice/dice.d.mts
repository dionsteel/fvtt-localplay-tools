 ...
 */
export function d20Roll({ parts, data, event, advantage, disadvantage, critical, fumble, targetValue, elvenAccuracy, halflingLucky, reliableTalent, fastForward, chooseModifier, template, title, dialogOptions, chatMessage, messageData, rollMode, flavor }?: D20RollConfiguration): Promise<D20Roll | null>;
/**
 ...
 */
export function damageRoll({ parts, data, event, allowCritical, critical, criticalBonusDice, criticalMultiplier, multiplyNumeric, powerfulCritical, criticalBonusDamage, fastForward, template, title, dialogOptions, chatMessage, messageData, rollMode, flavor }?: DamageRollConfiguration): Promise<DamageRoll | null>;
/**
 * Configuration data for a D20 roll.
 */

...
export default class DamageRoll {
     ...
     * @returns {DamageRoll}
     */
    static fromRoll(roll: Roll): DamageRoll;
    /**
     ...
     * @protected
     */
    protected configureDamage(): void;
    /** @inheritdoc */
    toMessage(messageData?: {}, options?: {}): any;
    /**
     ...
     *                                          dialog was closed
     */
    configureDialog({ title, defaultRollMode, defaultCritical, template, allowCritical }?: {
        title?: string;

 ...
 */
export default class Item5e {
    /**
     * Apply listeners to chat messages.
     * @param {HTML} html  Rendered chat message.
     */
    static chatListeners(html: HTML): void;
    /**
     ...
     */
    replaceFormulaData(formula: string, data: object, { property }: {
        property: string;
    }): string;
    /**
     ...
     * @protected
     */
    protected _getUsageUpdates({ consumeQuantity, consumeRecharge, consumeResource, consumeSpellSlot, consumeSpellLevel, consumeUsage }: {
        /**
         * Trigger a template creation
         */
        createMeasuredTemplate: boolean;
     ...
     * @protected
     */
    protected _handleConsumeResource(itemUpdates: object, actorUpdates: object, resourceUpdates: object[]): boolean | void;
    /**
     ...
     *                                       cannot be performed.
     */
    rollDamage({ critical, event, spellLevel, versatile, options }?: {
        event?: MouseEvent;
        critical?: boolean;
        spellLevel?: number;
        versatile?: boolean;
     ...
     */
    createAdvancement(type: string, data?: object, { showConfig, source }?: {
        showConfig?: boolean;
        source?: boolean;
     ...
     */
    updateAdvancement(id: string, updates: object, { source }?: {
        source?: boolean;
     ...
     */
    deleteAdvancement(id: string, { source }?: {
        source?: boolean;
    }): Promise<Item5e> | Item5e;
    /**
     ...
     */
    duplicateAdvancement(id: string, options?: {
        showConfig?: boolean;
        source?: boolean;
    }): Promise<AdvancementConfig> | Item5e;
    /** @inheritdoc */

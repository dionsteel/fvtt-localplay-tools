...
import { TokenDocumentPF2e } from "src/types/pf2e/module/scene/token-document/index.ts";
import { CheckDC, DegreeOfSuccessAdjustment } from "src/types/pf2e/module/system/degree-of-success.ts";

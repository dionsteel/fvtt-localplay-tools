import * as ActorInstance from "src/types/pf2e/module/actor";
import * as ItemInstance from "src/types/pf2e/module/item";
import { EffectTrait } from "src/types/pf2e/module/item/abstract-effect/index.ts";
import { ItemInstances } from "src/types/pf2e/module/item/types.ts";
...
import { immunityTypes, resistanceTypes, weaknessTypes } from "src/types/pf2e/module/scripts/config/iwr.ts";
...
import { StatisticCheck } from "src/types/pf2e/module/system/statistic/index.ts";
...
export { AbilityString, ActorAlliance, ActorDimensions, ActorInstances, ApplyDamageParams, AttackItem, AuraColors, AuraData, AuraEffectData, CheckContext, CheckContextParams, DCSlug, EmbeddedItemInstances, IWRType, ImmunityType, MovementType, ResistanceType, RollContext, RollContextParams, RollTarget, SaveType, SkillAbbreviation, SkillLongForm, StrikeSelf, UnaffectedType, WeaknessType, };

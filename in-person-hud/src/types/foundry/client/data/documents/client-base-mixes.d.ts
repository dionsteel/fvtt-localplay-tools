...
declare class ClientBaseAmbientLight<TParent extends ClientBaseScene | null> extends foundry.documents.BaseAmbientLight<TParent> {
...
declare class ClientBaseAmbientSound<TParent extends ClientBaseScene | null> extends foundry.documents.BaseAmbientSound<TParent> {
  protected _sheet: FormApplication<this> | null;
...
export class ClientBaseActor<TParent extends ClientBaseToken<ClientBaseScene | null> | null> extends foundry.documents.BaseActor<TParent> {
  protected _sheet: FormApplication<this> | null;
...
export class ClientBaseActorDelta<TParent extends ClientBaseToken<ClientBaseScene | null> | null> extends foundry.documents
...
export class ClientBaseAdventure extends foundry.documents.BaseAdventure {
  ...
  protected override _onUpdate(data: DeepPartial<this["_source"]>, options: DocumentModificationContext<null>, userId: string): void;
...
export class ClientBaseItem<TParent extends ClientBaseActor<ClientBaseToken<ClientBaseScene | null> | null> | null> extends foundry
  .documents.BaseItem<TParent> {
  protected _sheet: FormApplication<this> | null;
...
declare class ClientBaseMeasuredTemplate<TParent extends ClientBaseScene | null> extends foundry.documents.BaseMeasuredTemplate<TParent> {
  protected _sheet: FormApplication<this> | null;
 ...
 * @category - Mixins
 */
export class CanvasBaseMeasuredTemplate<TParent extends ClientBaseScene | null> extends ClientBaseMeasuredTemplate<TParent> {
  /** A reference to the PlaceableObject instance which represents this Embedded Document. */
  _object: PlaceableObject<this> | null;
...
export class ClientBasePlaylistSound<TParent extends ClientBasePlaylist | null> extends foundry.documents.BasePlaylistSound<TParent> {
  protected _sheet: FormApplication<this> | null;
...
export class ClientBaseTableResult<TParent extends ClientBaseRollTable | null> extends foundry.documents.BaseTableResult<TParent> {
  protected _sheet: FormApplication<this> | null;
